...
let rules = {
    ...
    // TODO: update details once Ghost v3 is shipped with a migration guide
    'GS001-DEPR-SUBSCRIBE': {
        level: 'warning',
        rule: 'The <code>{{subscribe_form}}</code> helper should not be used',
        details: oneLineTrim`The <code>{{subscribe_form}}</code> helper will be removed in next version of Ghost and should not be used.
        Find more information about the <code>{{subscribe_form}}</code> property <a href="${docsBaseUrl}subscribers/#subscribe-form-helper" target=_blank>here</a>.`,
        regex: /{{\s*?subscribe_form\s*?}}/g,
        helper: '{{subscribe_form}}'
    },
    'GS001-DEPR-CSS-KGMD': {
        level: 'warning',
